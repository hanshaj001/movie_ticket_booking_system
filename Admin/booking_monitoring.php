...
<div class="container">
    ...
    <form method="GET">
        <div class="filters">
            ...
            <select name="movie" required oninvalid="this.setCustomValidity('Please Select Movie')" onchange="this.setCustomValidity('')">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        echo "<span class='badge $status'>{$row['booking_status']}</span>";
                        ?>
                    </td>
                    ...
                    <td>
                        ...
                        <button class="action-btn cancel-btn" onclick="cancelBooking(<?php echo $row['booking_id']; ?>)">Cancel</button>
                        <?php } ?>
                    </td>
                </tr>
                <?php } ?>
    ...
    <div class="pagination">
        ...
        <?php for ($p = 1; $p <= $total_pages; $p++): ?>
            <a href="?date=<?= $selected_date ?>&page=<?= $p ?>" class="<?= ($page == $p) ? 'active' : '' ?>"><?= $p ?></a>
        <?php endfor; ?>
